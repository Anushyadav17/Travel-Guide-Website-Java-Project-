...
<%       
        ...
        PreparedStatement st = con.prepareStatement("SELECT * FROM serviceprovidertable");
        ...
        <section class="customersection">
            <table cellspacing="10">
                ...
                <%for(int i=0;i<list1.size();i++)
                  ...
                  <td style="display : flex; justify-content: space-evenly">
                       <form action="JavacodeDeleteSp.jsp">
                          <input type="text" value="<%=list7.get(i)%>" style="display: none" name="username">
            ...
            <table cellspacing="20px" id="hotelform">
                    <form action="JavacodeUpdateuser.jsp" method="post">
                     ...
                     <input type="text" name="post" style="display:none" value="serviceprovider">
                     <input type="text" name="viewpage" style="display:none" value="sp">
                      <input type="text" name="formadmin" style="display:none" value="admin">
                      <input type="text" name="section2" style="display:none" value="username">

                     <td><label for="hotelname">Enter Username</label></td>
                    ...
                    <tr>
                    <tr>
                        <td><input type="hide" id="button" onclick="hide()" value="Hide"></td>
