...
<%       
        ...
        PreparedStatement st = con.prepareStatement("select * from restotable where city=?");
        st.setString(1,city);
        ...
        else if(btn2 != null)
        {
          ...
          PreparedStatement st = con.prepareStatement("select * from restaurantltable where restaurantname=?");
...
<head>
  ...
  <title>Restaurants-BharatTour</title>
        ...
        <article class="ar1">
            ...
            <div>
             ...
             <form action="book.jsp">
                 ...
                 <input type="text" value="resto" style="display: none;" name="from">
