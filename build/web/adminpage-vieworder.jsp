                     ...
                     <tr>
                        ...
                        <td>
                            <select name="section" id="select">
                                ...
                                <option value="itemCharges">Charges</option>
                                <option value="bookItem">Book Item</option>
                                <option value="addressCustmer">Customer Address</option>
                                <option value="formDate">From Date</option>
                                <option value="toDate">To Date</option>
                                <option value="itemAddress">Booking Address</option>
                          </select>
                        </td>
                    </tr>
                    <tr>
