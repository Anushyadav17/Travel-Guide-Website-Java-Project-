...
<header class="header">
            ...
            <div class="otherItem">
                <ol>
                     <li>
                        <a href="serviceproviderpage-customerbooking.jsp" id="headerhome">Customer Booking</a>
                    </li>
                </ol>
            </div>
            <div class="otherItem">
                <ol>
                    <li>
                        <a href="serviceproviderpage-home.jsp" id="headerhome">Home</a>
                    </li>
                    ...
                    <li>
                        <a href="serviceproviderpage-myaccount.jsp" class="myacc">My Service</a>
                    </li>
