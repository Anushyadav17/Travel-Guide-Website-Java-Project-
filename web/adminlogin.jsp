...
<%
    ...
    if(button1!=null && button1.equals("Login"))
    {
      ...
      PreparedStatement st=con.prepareStatement("select * from  authoritytable  where empcode=? and username=? and password=?");
      ...
      if(rs.next())
      {
         ...
         response.sendRedirect(empCode+"page-home.jsp");
      }
      else
      {
         result=1;  
    ...
    <body>
        <section class="body">
           <form id="login-form" method="post">
               <h3>Login</h3>
                <input type="text" name="empCode" placeholder="Employee Code"/>
                <br>
