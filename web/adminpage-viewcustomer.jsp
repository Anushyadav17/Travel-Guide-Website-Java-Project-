        ...
        <section class="customersection">
            <table cellspacing="10">
                ...
                <%for(int i=0;i<list1.size();i++)
                  ...
                  <td style="display : flex; justify-content: space-evenly">
                       <form action="JavacodeDeleteUser.jsp">
            ...
            <table cellspacing="20px" id="hotelform">
                    <form action="JavacodeUpdateuser.jsp" method="post">
                     ...
                     <input type="text" name="post" style="display:none" value="customer">
                      ...
                      <input type="text" name="viewpage" style="display:none" value="customer">
