...
<%       
        ...
        PreparedStatement st = con.prepareStatement("SELECT * FROM restotable");
        ...
        <section class="customersection">
                ...
                <%for(int i=0;i<list1.size();i++)
                  ...
                  <td style="display : flex; justify-content: space-between">
                       ...
                       <form action="JavacodeDeleteResto.jsp">
                          <input type="text" value="<%=list6.get(i)%>" style="display: none" name="restoId">
            ...
            <table cellspacing="20px" id="hotelform">
                    <form action="JavacodeUpdateuser.jsp" method="post">
                     ...
                     <input type="text" name="post" style="display:none" value="resto">
                      <input type="text" name="formadmin" style="display:none" value="admin">
                      <input type="text" name="section2" style="display:none" value="restaurantid">
                      <input type="text" name="viewpage" style="display:none" value="Resto">

                     <td><label for="hotelname">Enter Restaurant Id</label></td>
                     ...
                     <tr>
                        ...
                        <td>
                            <select name="section" id="select">
                                ...
                                <option value="restaurantname">hotel name</option>
